...
export const mutations = `
  ...
  shareScore(ownerType: String, ownerId: String, score: Float, destinationId: String, destinationPhone: String, destinationEmail: String, destinationCode: String): String
`;
